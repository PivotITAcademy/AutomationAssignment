...
public class OrderInformationPage extends TestBase {
	...
	@FindBy(css = "div.alert.alert-success.alert-dismissible a:first-of-type")
	...
	@FindBy(css = "div.table-responsive tfoot tr:first-of-type td:nth-of-type(3)")
	WebElement subTotalValue;

	@FindBy(css = "div.table-responsive tfoot tr:last-of-type td:nth-of-type(3)")
	WebElement totalValue;

	@FindBy(css = "div.table-responsive tfoot tr:nth-of-type(2) td:nth-of-type(3)")
